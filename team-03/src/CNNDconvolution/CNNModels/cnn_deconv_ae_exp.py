...
class CNNDeconvAENet:
    def __init__(self):
        return

    def build_model(input_shape = (64, 64, 40, 1), learning_rate : float = 0.001, max_value : float = 1, is_need_bias : bool = True):
        enc_channels_1 = 20
        ...
        X_output = layers.Conv3D(1, (3, 3, 3), name = 'conv8_5', padding='same', use_bias=is_need_bias)(X)
        ...
        loss_func = loss_func_gen.make_loss(10)
        #loss_func = "mse"
