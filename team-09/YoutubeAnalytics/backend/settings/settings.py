...
from settings.mail_settings import *
import os
...
SECRET_KEY = '8hhn4pb)r%fgyo#x)q=)%hpg*!c!^8hdy#m&owdr86byrg2&!8via3uchz$^wgz7w0ggf6^)ck-j^1r!0+efqwye$==g(#g#h_6z'
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            "service": "youtube_analytics_service",
        },
    }
}
